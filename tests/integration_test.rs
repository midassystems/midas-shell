...
//     // Mbp-1
//     let schema = "mbp-1".to_string();
//     let file_path = "tests/data/mbp1_test.bin".to_string();
//
//     let historical_command = repl_shell::cli::historical::HistoricalArgs {
//         symbols: SYMBOLS.to_string(),
//         start: START.to_string(),
...
//     // Ohlcv
//     let schema = "ohlcv-1h".to_string();
//     let file_path = "tests/data/ohlcv1h_test.bin".to_string();
//
//     let historical_command = repl_shell::cli::historical::HistoricalArgs {
//         symbols: SYMBOLS.to_string(),
//         start: START.to_string(),
...
//     // Trades
//     let schema = "trade".to_string();
//     let file_path = "tests/data/trades_test.bin".to_string();
//
//     let historical_command = repl_shell::cli::historical::HistoricalArgs {
//         symbols: SYMBOLS.to_string(),
//         start: START.to_string(),
...
//     // Tbbo
//     let schema = "tbbo".to_string();
//     let file_path = "tests/data/tbbo_test.bin".to_string();
//
//     let historical_command = repl_shell::cli::historical::HistoricalArgs {
//         symbols: SYMBOLS.to_string(),
//         start: START.to_string(),
...
//     // Bbo
//     let schema = "bbo-1m".to_string();
//     let file_path = "tests/data/bbo1m_test.bin".to_string();
//
//     let historical_command = repl_shell::cli::historical::HistoricalArgs {
//         symbols: SYMBOLS.to_string(),
//         start: START.to_string(),
